    ...
    <Card className="overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="p-4 flex items-center justify-between border-b border-gray-100">
        ...
        <div className="flex items-center gap-2">
          {item.isPinned && (
            <Pin className="h-3.5 w-3.5 text-gray-400 rotate-45" />
          )}
          {renderTypeIcon()}
      ...
      <CardContent className="p-4">
        ...
        {item.type === "resource" && item.resource && (
          <div className="border border-gray-200 rounded-lg overflow-hidden mb-3 flex">
            ...
            <div className="p-3 flex-1">
              ...
              <Button
                variant="link"
                className="text-xs h-auto p-0 mt-1 text-pathpiper-teal"
              >
                View Resource
              </Button>
            </div>
        ...
        {item.media && item.media.length > 0 && (
          <div
            className={`grid ${item.media.length > 1 ? "grid-cols-2 gap-2" : "grid-cols-1"} mb-3`}
          >
      ...
      <CardFooter className="p-2 border-t border-gray-100 flex items-center justify-between">
        ...
        >
          <Bookmark
            className={`h-4 w-4 ${saved ? "fill-pathpiper-teal" : ""}`}
          />
        </Button>
      </CardFooter>
    </Card>
