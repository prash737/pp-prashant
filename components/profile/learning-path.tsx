...
import { Target, EditIcon, Calendar, Clock, CheckCircle2 } from "lucide-react"
...
export default function Goals({ student, currentUser }: GoalsProps) {
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="text-center py-12">
          <div className="max-w-md mx-auto">
            ...
            {isOwnProfile && (
              <Link href="/student/profile/edit">
                <Button className="mt-4 bg-pathpiper-teal hover:bg-pathpiper-teal/90">
                  Add Your First Goal
                </Button>
              </Link>
            )}
