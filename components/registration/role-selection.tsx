      ...
      <div className="grid grid-cols-1 gap-4 max-w-md mx-auto">
        {roles.map((role, index) => (
          ...
          >
            ...
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden h-48">
              {/* Normal state - static positioning to prevent collapse */}
              <div className="flex flex-col items-center justify-center h-full w-full p-6 group-hover:opacity-0 transition-opacity duration-300">
                <div
