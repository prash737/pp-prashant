...
export async function POST(request: NextRequest) {
  try {
    console.log('📸 Institution cover upload request received')
    ...
    console.log('✅ Institution cover converted to base64 successfully')
    ...
    console.error('Error uploading institution cover:', error)
    return NextResponse.json(
