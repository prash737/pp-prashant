...
export default function PublicViewInstitutionProfilePage({
  params,
}: {
  ...
  useEffect(() => {
    ...
    const fetchInstitutionData = async () => {
      try {
        ...
        console.log(
          "🏛️ Fetching comprehensive institution data for public view:",
          profileId,
        );
        ...
        console.log(
          "✅ Comprehensive institution data loaded for public view:",
          {
